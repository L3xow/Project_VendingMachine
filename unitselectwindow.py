...
class UnitSelectWindow(QWidget):
    def __init__(self, id_sweets, parent=None):
        ...
        # Call Labels
        self.labelGIF("src/Hampelmann.gif", 180, 210, 0)
        self.labelGIF("src/squats.gif", 620, 210, 1)
        self.labelGIF("src/pushup.gif", 1060, 210, 2)
        self.labelGIF("src/burpees.gif", 1500, 210, 3)
    ...
    def Unit_One(self):
        ...
        self.w = Ui_Dialog("src/Mainwindowdescr.txt", "src/Dialogwindowdescr.txt", "src/Hampelmann.gif", 1, self.id_sweets)
        self.w.show()
        self.close()
    ...
    def Unit_Two(self):
        # First and most important explanation, filler txt-file, GIF File, Exercise ID, saved sweet id which was
        # chosen in first Window from User
        self.w = Ui_Dialog("src/Mainwindowdescr.txt", "src/Dialogwindowdescr.txt", "src/squats.gif", 2, self.id_sweets)
        self.w.show()
        self.close()
    ...
    def Unit_Three(self):
        # First and most important explanation, filler txt-file, GIF File, Exercise ID, saved sweet id which was
        # chosen in first Window from User
        self.w = Ui_Dialog("src/Mainwindowdescr.txt", "src/Dialogwindowdescr.txt", "src/pushup.gif", 3, self.id_sweets)
        self.w.show()
        self.close()
    ...
    def Unit_Four(self):
        # First and most important explanation, filler txt-file, GIF File, Exercise ID, saved sweet id which was
        # chosen in first Window from User
        self.w = Ui_Dialog("src/Mainwindowdescr.txt", "src/Dialogwindowdescr.txt", "src/pushup.gif", 4, self.id_sweets)
        self.w.show()
        self.close()
